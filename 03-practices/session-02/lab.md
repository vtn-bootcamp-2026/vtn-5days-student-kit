...
updated-at: 2026-06-21 22:52 +07:00
---
...
> **Mục tiêu:** Ra 1 Workflow design doc hoàn chỉnh — hiện trạng (as-is) + ESIA + sơ đồ Mermaid + ảnh render workflow + sơ đồ so sánh Trước & Sau (Before & After) + danh sách bước cần tự động — sẵn sàng đưa sang n8n ở S3.
> **Thời lượng:** ~100 phút (trong session 3h30) · **Công cụ:** Antigravity / Codex, Mermaid, Codex / Nano Banana (Gemini), mermaid.live
...
| C — Bài tập nhóm (L3–L6)              | ~40 phút     | Code Mermaid hợp lệ + ảnh render workflow + sơ đồ Trước & Sau + design doc gộp. |
...
1. Tạo file **Workflow design doc** dựa trên template [templates/workflow-design-doc-template.md](templates/workflow-design-doc-template.md). Gồm 6 phần:
   ...
   6. Danh sách bước cần tự động — liệt kê các bước đánh A, mỗi bước ghi rõ **có cần HITL hay không**.

- **Đầu ra C4:** 1 file `workflow-design-doc-[tên-quy-trình].md` hoàn chỉnh đã chèn đủ 2 ảnh và các bảng phân tích.
...
> Nghiệm thu tối thiểu: **có đủ as-is + to-be · sơ đồ Mermaid render được · ≥1 bước Automate · ≥1 điểm HITL được đánh dấu · sơ đồ Before & After.**
...
*Bàn giao sang Session 3: Workflow design doc (as-is + ESIA + Mermaid + ảnh render + sơ đồ Before & After + danh sách bước cần tự động) → dựng trên n8n. Đồng bộ: `lab.md`, `01-slides/designs/session-02-theory.md`, `trouble-cards.md`, `synthetic-data/`, `fallback-inputs/`.*
