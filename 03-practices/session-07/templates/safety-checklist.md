...
**Nhóm:** ______________   **Ca thực hành:** Buổi 07 - Hermes Basic   **Ngày:** ____________

> [!IMPORTANT]
> Mẫu này dùng cho Session 07 - Hermes Basic. Học viên điền và nộp cùng `runbook-log.json` để xác nhận đã hoàn thành xóa bộ nhớ (Memory Clear Protocol) và không rò rỉ dữ liệu.
