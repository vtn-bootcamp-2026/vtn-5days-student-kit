...
1. Sao chép 4 tệp chính sách nhân sự mô phỏng (leave, allowance, seniority, training) từ thư mục `03-practice/session-07/synthetic-data/hr-policies/` sang thư mục `03-practice/session-07/outputs/skills/hr-policy-qa-skill/kb/hr-policies/`.
...
3. Tạo tệp kiểm kê tri thức `03-practice/session-07/outputs/skills/hr-policy-qa-skill/kb/kb-inventory.md` liệt kê danh sách 4 tài liệu trên, mã tài liệu tương ứng (POL-LEAVE-001, POL-ALLOW-001, POL-SENIOR-001, POL-TRAIN-001) và tóm tắt ngắn gọn phạm vi bao phủ của từng tài liệu.
4. Viết tệp lược đồ JSON tại `03-practice/session-07/outputs/skills/hr-policy-qa-skill/schemas/hr-response.schema.json` tuân thủ tiêu chuẩn Draft-07 để cấu trúc hóa câu trả lời của tác nhân: Agent. Lược đồ cần bắt buộc chứa đúng 10 trường sau:
