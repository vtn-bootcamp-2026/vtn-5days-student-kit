...
`03-practice/session-07/outputs/skills/hr-policy-qa-skill/scripts/retriever.py`

Hãy thực hiện các yêu cầu sau:
1. Sao chép tệp mẫu `03-practice/session-07/templates/skills/hr-policy-qa-skill/scripts/retriever.py` sang thư mục đích `03-practice/session-07/outputs/skills/hr-policy-qa-skill/scripts/retriever.py` (nếu chưa có).
