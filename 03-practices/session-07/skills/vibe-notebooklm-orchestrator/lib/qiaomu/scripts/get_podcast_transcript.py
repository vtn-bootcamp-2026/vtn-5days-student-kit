...
# Token file: env override > bundled location > legacy ~/.claude location
_GETNOTE_TOKEN_DEFAULT = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'data', 'tokens.json')
TOKENS_FILE = os.environ.get('GETNOTE_TOKENS_FILE') or _GETNOTE_TOKEN_DEFAULT
